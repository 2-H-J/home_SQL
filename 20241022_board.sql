...
------------------------------------------------------------------------------------------
--외래키 ON DELETE CASCADE 추가
-- BOARD 테이블 외래 키 생성
ALTER TABLE BOARD 
ADD CONSTRAINT BOARD_FK_ID FOREIGN KEY (id) 
REFERENCES USER(id) ON DELETE CASCADE;

-- BOARD_CONTENT_LIKE 테이블 외래 키 생성
...
-- BOARD_CONTENT_HATE 테이블 외래 키 생성
...
-- BOARD_COMMENT_LIKE 테이블 외래 키 생성
...
-- BOARD_COMMENT_HATE 테이블 외래 키 생성
...
values('A0001',STANDARD_HASH('123456','SHA512'),'유저이름','닉네임');
...
AS 
SELECT BC.*, BM.NICKNAME, NVL(BCL.BCL_COUNT,0) AS clike,
NVL(BCH.BCH_COUNT,0) AS chate
...
SELECT * FROM BOARD_COMMENT WHERE BNO = 1001;
