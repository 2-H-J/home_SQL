...
INSERT INTO EEMP VALUES(001, 100, 2500);
INSERT INTO EEMP VALUES(002, 100, 3000);
INSERT INTO EEMP VALUES(003, 200, 4500);
INSERT INTO EEMP VALUES(004, 200, 3000);
INSERT INTO EEMP VALUES(005, 200, 2500);
INSERT INTO EEMP VALUES(006, 300, 4500);
INSERT INTO EEMP VALUES(007, 300, 3000);

SELECT EID, COL1, COL2, COL3
FROM (SELECT EID, ROW_NUMBER() OVER(PARTITION BY DID ORDER BY ESAL DESC) AS COL1,
					SUM(ESAL) OVER(PARTITION BY DID ORDER BY EID ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW) AS COL2,
					MAX(ESAL) OVER(ORDER BY ESAL DESC ROWS CURRENT ROW) AS COL3 
	FROM EEMP)
WHERE COL1 = 2
ORDER BY 1;
